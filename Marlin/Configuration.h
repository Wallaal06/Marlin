...
#define STRING_CONFIG_H_AUTHOR "(Andrew Wallace)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DREW"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  29.37,  29.37 }
    #define DEFAULT_Ki_LIST {   2.65,   2.65 }
    #define DEFAULT_Kd_LIST { 81.51, 81.51 }
  #else
    #define DEFAULT_Kp  29.37
    #define DEFAULT_Ki   2.65
    #define DEFAULT_Kd 81.51
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 65.48
  #define DEFAULT_bedKi 12.90
  #define DEFAULT_bedKd 221.57
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 20000, 20000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, -48, -1.45 }
